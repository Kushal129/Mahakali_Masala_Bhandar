...
import chiliImg from './Img/chili1.png';
import turmericImg from './Img/haldar.jpg';
import corianderCuminImg from './Img/jeerapowder.png';
import asafoetidaImg from './Img/hing.png';

import floatingChili from './Img/chili.png';
import floatingTurmeric from './Img/Turmeric.png';
import floatingCoriander from './Img/Coriander-Cumin.png';
import floatingAsafoetida from './Img/Asafoetida.png';
...
// Mobile floating spices configuration
const mobileFloatingSpices = [
  { top: '10%', left: '5%', delay: 0, image: floatingChili },
  { top: '25%', right: '5%', delay: 0.2, image: floatingTurmeric },
  { top: '40%', left: '6%', delay: 0.4, image: floatingCoriander },
              ...
              >
                ...
                >
                  <img
                    src={spice.image}
                    alt="Floating Spice"
                    className="w-16 h-16 object-contain rounded-full shadow-lg shadow-red-500/30"
                  />
                </motion.div>
              </motion.div>
            ))}
